...
class RideTest(unittest.TestCase):
    ...
    def test_different_shortest_paths(self):
        start = 2
        end = 5
        passengers = [3]
        roads = [
        ...
        self.assertTrue(my_res == res_1 or my_res == res_2)
    ...
    def test_undirected_paths(self):
        ...
        result = [0, 2, 3, 4]  # optimal route should take 19 mins
        self.assertEqual(optimalRoute(start, end, passengers, roads), result)

    def test_non_passengers_location(self):
        start = 0
        end = 4
        passengers = []
        roads = [
        ...
        result = [0, 3, 2, 4]  # optimal route should take 37 mins
        self.assertEqual(optimalRoute(start, end, passengers, roads), result)
    ...
    def test_customer_somewhere_not_reached(self):
        start = 0
        end = 4
        passengers = [2]
        roads = [
    ...
    def test_pass_cust_but_longer(self):
        start = 0
        end = 3
        passengers = [2]
        roads = [
